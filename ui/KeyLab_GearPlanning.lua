    ...
    },
    {
        ...
        body = Join({
            ...
            List({
                ...
                "Make sure the four goals total 100%; a stat may be set to 0%.",
                "Run the Stat Goal Matcher.",
                "Review Goal Match items and mark anything you want as a Target or Alternative.",
            }),
            "KeyLab includes the secondary-stat ratings from equipped gear and searches eligible non-Tier dungeon and raid items for your current class and specialization. It identifies the combination that most closely approaches your chosen percentages. Crafted Items and Tier pieces are not included in its recommendations.",
            Tip(),
