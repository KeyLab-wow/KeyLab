...
local function NewTab(mode, profileType)
    ...
    function tab:Create(parent)
        ...
        self.metricDropdown = CreateFrame("Frame", nil, specPanel, "UIDropDownMenuTemplate")
        ...
        Font(specPanel, "Season Leaderboards", 600, -12, 300, "GameFontDisableSmall", MUTED, "RIGHT")
        Font(specPanel, "Top 5 DPS  •  Top 5 HPS", 600, -38, 300, "GameFontHighlightSmall", TEXT, "RIGHT")
