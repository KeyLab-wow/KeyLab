...
function Sequencer:EnsureGroupTargetDialog()
    ...
    dialog.help:SetPoint("TOPLEFT",18,-58); dialog.help:SetSize(414,46)
    dialog.nameLabel=Text(dialog,"Macro Target Name","GameFontHighlightSmall",10,COLORS.muted); dialog.nameLabel:SetPoint("TOPLEFT",18,-114)
    dialog.nameBox=EditBox(dialog,414); dialog.nameBox:SetPoint("TOPLEFT",18,-134); dialog.nameBox:SetMaxLetters(40)
